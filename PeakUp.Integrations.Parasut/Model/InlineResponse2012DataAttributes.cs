...
namespace PeakUp.Integrations.Parasut.Model
{
    ...
    public partial class InlineResponse2012DataAttributes :  IEquatable<InlineResponse2012DataAttributes>, IValidatableObject
    {
        ...
        public InlineResponse2012DataAttributes(DateTime? Date = default(DateTime?), decimal? Amount = default(decimal?), decimal? Currency = default(decimal?), string Notes = default(string))
        {
            this.Date = Date;
            this.Amount = Amount;
