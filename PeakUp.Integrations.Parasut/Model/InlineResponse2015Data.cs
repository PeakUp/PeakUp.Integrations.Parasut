...
namespace PeakUp.Integrations.Parasut.Model
{
    ...
    public partial class InlineResponse2015Data :  IEquatable<InlineResponse2015Data>, IValidatableObject
    {
        ...
        public InlineResponse2015Data(string Id = default(string), TypeEnum? Type = default(TypeEnum?), InlineResponse200Meta Meta = default(InlineResponse200Meta), InlineResponse2015DataAttributes Attributes = default(InlineResponse2015DataAttributes))
        {
            this.Id = Id;
            this.Type = Type;
            this.Meta = Meta;
