...
namespace PeakUp.Integrations.Parasut.Model
{
    ...
    public partial class CompanyIdeArchivesData :  IEquatable<CompanyIdeArchivesData>, IValidatableObject
    {
        ...
        public CompanyIdeArchivesData(string Id = default(string), TypeEnum? Type = default(TypeEnum?), CompanyIdeArchivesDataAttributes Attributes = default(CompanyIdeArchivesDataAttributes), CompanyIdeArchivesDataRelationships Relationships = default(CompanyIdeArchivesDataRelationships))
        {
            this.Id = Id;
            this.Type = Type;
